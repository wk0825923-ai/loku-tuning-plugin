...
const RULES = [
  ...
  { cat: '景表法・健康増進法（痩身）', sev: 'high',   terms: ['必ず痩せ', 'かならず痩せ', '絶対痩せ', 'ゼッタイ痩せ', '確実に痩せ', '誰でも痩せ', 'だれでも痩せ', 'リバウンドしない', 'リバウンドゼロ', '部分痩せ', '楽して痩せ', 'ラクして痩せ', '飲むだけで痩せ', '着るだけで痩せ', '寝るだけで痩せ', '脂肪が溶け', '脂肪を溶か', 'セルライトが消え', '痩せる保証', '痩身保証', '痩せなければ返金', '痩せなかったら返金'] },
  { cat: '景表法・健康増進法（痩身）', sev: 'medium', terms: ['痩せる', '痩せた', 'やせる', 'ヤセる', '痩身', 'ダイエット効果', 'ボディメイク効果', '体質改善', 'くびれ', '脚やせ', '全額返金', '返金保証', 'モニター価格'] },
];
